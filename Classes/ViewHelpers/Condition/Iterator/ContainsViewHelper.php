...
namespace Bb\Standards\ViewHelpers\Condition\Iterator;

/*
 * This file is part of the Bb\Standards project under GPLv2 or later.
 *
 ...
 *
 * ```
 * {bbs:condition.iterator.contains(needle: 'foo', haystack: {0: 'foo'}, then: 'yes', else: 'no')}
 * ```
 */
